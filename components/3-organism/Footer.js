const Footer = () => {
  return (
    <footer className=' w-full left-0 bottom-0 text-center pearl text-blue'>
      <div className='p-8 container flex mx-auto justfy-items-center'>
        <div className='mx-auto w-1/4 '>
          <h1 className='p-4 text-lg font-bold'>Dove siamo</h1>
          <p className='p-2'>
            <a
        ...
        <div className='mx-auto w-1/4 '>
          <h1 className='p-4 text-lg font-bold '>Contatti</h1>
          <p className='p-2'>
            <b>Telefono: </b>
        ...
        <div className='mx-auto w-1/4 '>
          <h1 className='p-4 text-lg font-bold '>Orari</h1>
          <p className='p-2'>
            <b>Mar:</b> 18:00/20:00
          </p>
          <p className='p-2'>
        ...
        <div className='mx-auto w-1/4 '>
          <h1 className='p-4 text-lg font-bold'>Social</h1>
          <p className='p-2'>
            <a
              className='hover:text-blue-600'
